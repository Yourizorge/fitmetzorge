...
**Gepubliceerd en vrijgegeven op appfmz.nl.** Runtimecommit: [`fae170057376ccd83180e2cde1973fc23938f054`](https://github.com/Yourizorge/fitmetzorge/commit/fae170057376ccd83180e2cde1973fc23938f054). De aparte branch en main zijn gepusht; [GitHub Pages-run 34508610901](https://github.com/Yourizorge/fitmetzorge/actions/runs/34508610901) is succesvol. Alle 13 live runtimebestanden (inclusief beide lokale bibliotheken, configuratie, sync en logo) zijn byte voor byte gelijk aan de commit. De normale app is actief; er staat geen onderhoudsscherm op de root.

De daadwerkelijke live mobiele frontend is met het synthetische owneraccount geopend. Een opzettelijke private-Storage-downloadfout gaf één fout; opnieuw downloaden leverde application/pdf met dezelfde factuur-ID's/nummers. Geen browserfouten of horizontale overloop bij 390 pixels. De geverifieerde echte owner is daarna gecontroleerd aanwezig als enige blijvende organisatie-owner. Bedrijfsnaam, adres, postcode/plaats, KVK en btw-ID zijn niet leeg in de overgenomen gegevens; juistheid en fiscale keuzes moeten nog door de owner worden bevestigd. Er is nog geen bevestigde bankrekening/beginstand en de historische aansluiting is nog niet bevestigd. Dit zijn zichtbare eenmalige ingebruiknamestappen, geen verzonnen nulstanden of fiscale goedkeuring.

Uitsluitend de eigen synthetische bijlagen, administratie en vier testaccounts zijn verwijderd. Eindstand: nul synthetische accounts/organisaties en nul testbestanden; één echte ownerorganisatie met historische bron en onbevestigde instellingen. De oorspronkelijke zeven profielen, twee workspaces en tien uitnodigingen blijven behouden. De volledige workspace-SHA-256 is vóór/na exact `be5e848338a22baab2394e50d4d320a0ba7f4f80334ccafac52f7dbf1d3f0254`; de annotatie-SHA-256 is vóór/na exact `387911d0112b1077e1ee464c54d93d5f98122245431500e732f5c27fe6502b60`.

Ook de schone eindtoestand met ownerkoppeling is versleuteld geback-upt en geïsoleerd teruggelezen op `2026-09-10T17:41:24Z`: SHA-256 `89fb2570502442801fbd1f9281f3a46f42a29a21c25ecb4cb523eaf1e48f00c8`. Dit herstelpunt bevat alle dertien APPFMZ/administratietabellen; op dat moment zijn er na schoonmaak geen Storage-objecten. Het afzonderlijke exportherstel heeft juist de vijf echte synthetische Storage-bestanden gecontroleerd. Nieuwe bijlagen na dit moment vallen onder de downloadbare volledige archiefexport; automatische onafhankelijke off-site bijlagenback-up blijft een expliciet ontbrekende voorziening.

Deze laatste rapportaanvulling wijzigt alleen documentatie. De runtime blijft gelijk aan fae1700; een automatische Pages-herpublicatie van deze documentatie verandert de appbestanden niet.
