...
const root=path.resolve(__dirname,'..'),allowed=new Set(['index.html','app.js','sync.js','autosave.js','photos.js','invoices.js','styles.css','config.js','fit-met-zorge-logo.png','vendor/pdf-lib-1.17.1.min.js']);
